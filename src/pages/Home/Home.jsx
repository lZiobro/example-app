...
function Home() {
  ...
  const handleHomeScroll = (e) => {
    ...
    if (window.scrollY < heightWithoutNavbar && prevScroll < window.scrollY)
      ...
      prevScroll >= heightWithoutNavbar &&
      window.scrollY < heightWithoutNavbar
    )
  ...
  return (
    <>
        ...
        <div className="homepage-wrapper homepage-wrapper-big old-paper-background">
          <div className="column-wrapper background-photo-text-panel fullscreen">
            ...
            <div className="row-wrapper">
              ...
              <Link
                to="/mercenaries"
                className="check-listings join-us primary-btn pulsating"
              >
                <b>Check our listings!</b>
              </Link>
            </div>
          </div>
        </div>
      ...
      <div className="homepage-wrapper old-paper-background soft-edges">
        ...
        <div className="column-wrapper home-top-content">
          ...
          <div className="row-wrapper">
            <span>
              ...
              <p>
                Over the years, we've helped countless adventurers complete
                their goals e.g.:
              </p>
              <ul>
                <li>
                  <b>Overturning the tyranny of King Armed Ler.</b>
                </li>
                <li>
                  <b>Gathering forces for the Battles of the Fords of Isen.</b>
                </li>
                <li>
                  <b>
                    Recovering the lonely mountain from the occupation of Smaug.
                  </b>
                </li>
              </ul>
        ...
        <div className="column-wrapper home-panels-wrapper soft-edges abc">
          <div className="photo-text-panel soft-edges">
            <img
              ...
              src={aragorn}
              alt="smiling adventurer"
            />
            <h3>
              Here, you can find all the best adventurers from the middlearth.
            </h3>
            <p>
              We have a whole variety of people from burglars through warriors
              to mages.
            </p>
          </div>
          ...
          <div className="photo-text-panel soft-edges">
            ...
            <p>
              All you have to do is go to your profile, and list yourself from
              here.
            </p>
          </div>
        </div>
        ...
        <h2>
          <u>
            We are also against all the evil, so you wont find any Sauron
            servants here!
          </u>
        </h2>
        ...
        <div className="background-photo-text-panel soft-edges">
          ...
          <Link to="/register" className="join-us primary-btn zoomOnHover">
            <b>JOIN US NOW!</b>
          </Link>
        </div>
      </div>
